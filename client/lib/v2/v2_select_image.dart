...
class V2SelectImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return V2IsMobileWidget(
      isMobile: ((isMobile, isTablet, isDesktop) => Card(
                  ...
                  subtitle: Column(
                    ...
                    children: [
                      ...
                      RawKeyboardListener(
                        ...
                        onKey: (x) async {
                          if (x.isControlPressed && x.character != null && x.character.toString().toLowerCase() == "v" || x.isMetaPressed && x.character.toString().toLowerCase() == "v") {
