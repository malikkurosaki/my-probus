...
class V2Api {
  ...
  V2Api.issueByDepartementId() : path = '/issue-by-departement-id';
  V2Api.issueHistory() : path = '/issue-history';
  V2Api.todoList() : path = '/todo-list';
  V2Api.todoUpdate() : path = '/todo-update';
  V2Api.issueDelete() : path = '/issue-delete';
  ...
  // get
  Future<http.Response> getByQuery(String param) => http.get(Uri.parse('${Config.host}/api/v2$path?$param'));
